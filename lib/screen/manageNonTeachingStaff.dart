...
import 'package:college_management_system/providers/nonteachingStaffProvider.dart';
...
class NonTeachingStaff extends StatefulWidget {
  @override
  _NonTeachingStaffState createState() => _NonTeachingStaffState();
}
...
class _NonTeachingStaffState extends State<NonTeachingStaff> {
  ...
  insert() async {
    ...
    Provider.of<NonTeachingStaffProvider>(context, listen: false)
        .addTeachingStaff(teachingStaffObject);
  }

  List<NonTeachingStaffObject> teachingAll = [];
  List<UserInfoObj> userAll = [];
  UserInfoObj userInfoObj = UserInfoObj();
  NonTeachingStaffObject teachingStaffObject = NonTeachingStaffObject();
  ...
  fetchData() async {
    ...
    teachingAll =
        await Provider.of<NonTeachingStaffProvider>(context, listen: false)
            .getTeachingDetail();
    userAll = await Provider.of<NonTeachingStaffProvider>(context, listen: false)
        .getUserDetail();
                              ...
                              itemBuilder: (context, i) => Padding(
                                ...
                                child: InkWell(
                                  onTap: () {
                                    ...
                                    Provider.of<NonTeachingStaffProvider>(context,
                                            listen: false)
                    ...
                    child: RaisedButton(
                      ...
                      onPressed: () async {
                        try {
                          ...
                          teachingStaffObject.designation = designationCon.text;
                          ...
                          _isEdit
                              ? await Provider.of<NonTeachingStaffProvider>(
                                      context,
                                      listen: false)
