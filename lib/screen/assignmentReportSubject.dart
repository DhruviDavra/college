...
class AssignmentSubReport extends StatefulWidget {
  @override
  _AssignmentSubReportState createState() =>
      _AssignmentSubReportState();
}

class _AssignmentSubReportState
    extends State<AssignmentSubReport> {
                                  ...
                                  child: InkWell(
                                    onTap: () {
                                      Provider.of<AssignmentSubmissionProvider>(
                                              context,
                                              listen: false)
                                          .selectedSubForReport = subject[i].subName;
