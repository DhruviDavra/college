...
class NonStaffProfile extends StatefulWidget {
  @override
  _NonStaffProfileState createState() => _NonStaffProfileState();
}

class _NonStaffProfileState extends State<NonStaffProfile> {
